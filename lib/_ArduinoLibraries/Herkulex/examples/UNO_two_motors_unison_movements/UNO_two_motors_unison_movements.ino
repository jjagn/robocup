...
void setup()  
{
  ...
  Herkulex.begin(115200,10,11); //open serial port software 
  ...
  Serial.println(Herkulex.stat(0xfd));
  ...
  Herkulex.moveSpeedAll(0xfd,300,1);
  ...
  Herkulex.moveAll(0xfd, 200, 2); //move to position 200
  ...
  Herkulex.moveAllAngle(0xfd, 120.5, 2);;
